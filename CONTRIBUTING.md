# Contributing to Lantern analytics wrapper

Owning team: @northgate/digital-analytics-enablement. Ask in `#digital-analytics` on the internal chat platform before starting anything that
...
Feature branches are `feature/LNTN-1234-short-description`. Also permitted: `bugfix/`, `hotfix/`,
`spike/`, `chore/`. The pre-commit hook rejects anything else.

## Commits

`LNTN-1234 imperative summary`, 72 characters or fewer, with an optional body explaining why. The
