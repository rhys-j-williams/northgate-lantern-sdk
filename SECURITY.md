# Application security standard — Lantern analytics wrapper

Owner: @northgate/digital-analytics-enablement. Standard reference: GIS-STD-014 Application Security Requirements for Internet
...
(`gis-appsec-intake@northgate.internal`) with the component name `lantern-sdk` and, if the finding came
