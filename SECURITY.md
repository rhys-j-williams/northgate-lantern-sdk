...
Owner: @meridian/digital-analytics-enablement. Standard reference: GIS-STD-014 Application Security Requirements for Internet
...
(`gis-appsec-intake@meridian.internal`) with the component name `lantern-sdk` and, if the finding came
